...
import { TermsConditionsUpload } from "@/components/terms-conditions/terms-conditions-upload";
import { TermsConditionsViewer } from "@/components/terms-conditions/terms-conditions-viewer";
...
export function TermsConditionsCard({
  ...
  console.log("TermsConditionsCard rendering with companyId:", companyId);

  const t = useTranslations("Dashboard.companyProfile.termsConditions");
  const tCommon = useTranslations("Common");
  const locale = useLocale();

  // T&C hook for data management
  let hookResult;
  try {
    hookResult = useTermsConditions(companyId);
    console.log("useTermsConditions hook result:", hookResult);
  } catch (error) {
  ...
  try {
    title = t("title");
    console.log("Translation for title:", title);
  } catch (error) {
    console.error("Translation error:", error);
    title = "Terms & Conditions"; // Fallback
  }
